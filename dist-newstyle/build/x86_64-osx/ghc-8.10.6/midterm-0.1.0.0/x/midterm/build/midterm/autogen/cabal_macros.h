...
/* package midterm-0.1.0.0 */
#ifndef VERSION_midterm
#define VERSION_midterm "0.1.0.0"
#endif /* VERSION_midterm */
#ifndef MIN_VERSION_midterm
#define MIN_VERSION_midterm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_midterm */
...
#define CURRENT_COMPONENT_ID "midterm-0.1.0.0-inplace-midterm"
